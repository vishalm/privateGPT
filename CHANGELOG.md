...
## [0.0.1](https://github.com/vishalm/privateGPT/compare/v0.6.2...v0.0.1) (2025-05-20)
...
* add retry connection to ollama ([#2084](https://github.com/vishalm/privateGPT/issues/2084)) ([77461b9](https://github.com/vishalm/privateGPT/commit/77461b96cf2e18b88b592fff441206a49826db97))
...
* Adding MistralAI mode ([#2065](https://github.com/vishalm/privateGPT/issues/2065)) ([f9182b3](https://github.com/vishalm/privateGPT/commit/f9182b3a86d88af7c699b41b3a5f21401117acfc))
...
* bump dependencies ([#1987](https://github.com/vishalm/privateGPT/issues/1987)) ([b687dc8](https://github.com/vishalm/privateGPT/commit/b687dc852413404c52d26dcb94536351a63b169d))
* **code:** improve concat of strings in ui ([#1785](https://github.com/vishalm/privateGPT/issues/1785)) ([bac818a](https://github.com/vishalm/privateGPT/commit/bac818add51b104cda925b8f1f7b51448e935ca1))
...
* **docker:** set default Docker to use Ollama ([#1812](https://github.com/vishalm/privateGPT/issues/1812)) ([f83abff](https://github.com/vishalm/privateGPT/commit/f83abff8bc955a6952c92cc7bcb8985fcec93afa))
* **docs:** Add guide Llama-CPP Linux AMD GPU support ([#1782](https://github.com/vishalm/privateGPT/issues/1782)) ([8a836e4](https://github.com/vishalm/privateGPT/commit/8a836e4651543f099c59e2bf497ab8c55a7cd2e5))
* **docs:** add privategpt-ts sdk ([#1924](https://github.com/vishalm/privateGPT/issues/1924)) ([d13029a](https://github.com/vishalm/privateGPT/commit/d13029a046f6e19e8ee65bef3acd96365c738df2))
* **docs:** Feature/upgrade docs ([#1741](https://github.com/vishalm/privateGPT/issues/1741)) ([5725181](https://github.com/vishalm/privateGPT/commit/572518143ac46532382db70bed6f73b5082302c1))
* **docs:** Fix setup docu ([#1926](https://github.com/vishalm/privateGPT/issues/1926)) ([067a5f1](https://github.com/vishalm/privateGPT/commit/067a5f144ca6e605c99d7dbe9ca7d8207ac8808d))
* **docs:** update doc for ipex-llm ([#1968](https://github.com/vishalm/privateGPT/issues/1968)) ([19a7c06](https://github.com/vishalm/privateGPT/commit/19a7c065ef7f42b37f289dd28ac945f7afc0e73a))
* **docs:** update documentation and fix preview-docs ([#2000](https://github.com/vishalm/privateGPT/issues/2000)) ([4523a30](https://github.com/vishalm/privateGPT/commit/4523a30c8f004aac7a7ae224671e2c45ec0cb973))
...
* **ingest:** Created a faster ingestion mode - pipeline ([#1750](https://github.com/vishalm/privateGPT/issues/1750)) ([134fc54](https://github.com/vishalm/privateGPT/commit/134fc54d7d636be91680dc531f5cbe2c5892ac56))
...
* **llm:** add progress bar when ollama is pulling models ([#2031](https://github.com/vishalm/privateGPT/issues/2031)) ([cf61bf7](https://github.com/vishalm/privateGPT/commit/cf61bf780f8d122e4057d002abf03563bb45614a))
...
* **llm:** autopull ollama models ([#2019](https://github.com/vishalm/privateGPT/issues/2019)) ([20bad17](https://github.com/vishalm/privateGPT/commit/20bad17c9857809158e689e9671402136c1e3d84))
...
* **llm:** Ollama LLM-Embeddings decouple + longer keep_alive settings ([#1800](https://github.com/vishalm/privateGPT/issues/1800)) ([b3b0140](https://github.com/vishalm/privateGPT/commit/b3b0140e244e7a313bfaf4ef10eb0f7e4192710e))
* **llm:** Ollama timeout setting ([#1773](https://github.com/vishalm/privateGPT/issues/1773)) ([6f6c785](https://github.com/vishalm/privateGPT/commit/6f6c785dac2bbad37d0b67fda215784298514d39))
* **llm:** Support for Google Gemini LLMs and Embeddings ([#1965](https://github.com/vishalm/privateGPT/issues/1965)) ([fc13368](https://github.com/vishalm/privateGPT/commit/fc13368bc72d1f4c27644677431420ed77731c03))
...
* make llama3.1 as default ([#2022](https://github.com/vishalm/privateGPT/issues/2022)) ([9027d69](https://github.com/vishalm/privateGPT/commit/9027d695c11fbb01e62424b855665de71d513417))
...
* prompt_style applied to all LLMs + extra LLM params. ([#1835](https://github.com/vishalm/privateGPT/issues/1835)) ([e21bf20](https://github.com/vishalm/privateGPT/commit/e21bf20c10938b24711d9f2c765997f44d7e02a9))
...
* **rag:** expose similarity_top_k and similarity_score to settings ([#1771](https://github.com/vishalm/privateGPT/issues/1771)) ([087cb0b](https://github.com/vishalm/privateGPT/commit/087cb0b7b74c3eb80f4f60b47b3a021c81272ae1))
* **RAG:** Introduce SentenceTransformer Reranker ([#1810](https://github.com/vishalm/privateGPT/issues/1810)) ([83adc12](https://github.com/vishalm/privateGPT/commit/83adc12a8ef0fa0c13a0dec084fa596445fc9075))
* **recipe:** add our first recipe  `Summarize` ([#2028](https://github.com/vishalm/privateGPT/issues/2028)) ([8119842](https://github.com/vishalm/privateGPT/commit/8119842ae6f1f5ecfaf42b06fa0d1ffec675def4))
...
* **scripts:** Wipe qdrant and obtain db Stats command ([#1783](https://github.com/vishalm/privateGPT/issues/1783)) ([ea153fb](https://github.com/vishalm/privateGPT/commit/ea153fb92f1f61f64c0d04fff0048d4d00b6f8d0))
...
* **ui:** Add Model Information to ChatInterface label ([f0b174c](https://github.com/vishalm/privateGPT/commit/f0b174c097c2d5e52deae8ef88de30a0d9013a38))
...
* **UI:** Faster startup and document listing ([#1763](https://github.com/vishalm/privateGPT/issues/1763)) ([348df78](https://github.com/vishalm/privateGPT/commit/348df781b51606b2f9810bcd46f850e54192fd16))
...
* update llama-index + dependencies ([#2092](https://github.com/vishalm/privateGPT/issues/2092)) ([5851b02](https://github.com/vishalm/privateGPT/commit/5851b02378313f3dba315e0251cfd421af79dae6))
...
* **vectordb:** Milvus vector db Integration ([#1996](https://github.com/vishalm/privateGPT/issues/1996)) ([43cc31f](https://github.com/vishalm/privateGPT/commit/43cc31f74015f8d8fcbf7a8ea7d7d9ecc66cf8c9))
* **vectorstore:** Add clickhouse support as vectore store ([#1883](https://github.com/vishalm/privateGPT/issues/1883)) ([2612928](https://github.com/vishalm/privateGPT/commit/26129288394c7483e6fc0496a11dc35679528cc1))
...
* wipe per storage type ([#1772](https://github.com/vishalm/privateGPT/issues/1772)) ([c2d6948](https://github.com/vishalm/privateGPT/commit/c2d694852b4696834962a42fde047b728722ad74))


### Bug Fixes

* "no such group" error in Dockerfile, added docx2txt and cryptography deps ([#1841](https://github.com/vishalm/privateGPT/issues/1841)) ([947e737](https://github.com/vishalm/privateGPT/commit/947e737f300adf621d2261d527192f36f3387f8e))
* 294 (tested) ([4cda348](https://github.com/vishalm/privateGPT/commit/4cda348cf87f56ff237e376b03732b1b47a99215))
* 503 when private gpt gets ollama service ([#2104](https://github.com/vishalm/privateGPT/issues/2104)) ([940bdd4](https://github.com/vishalm/privateGPT/commit/940bdd49af14d9c1e7fd4af54f12648b5fc1f9c0))
...
* add built image from DockerHub ([#2042](https://github.com/vishalm/privateGPT/issues/2042)) ([f09f6dd](https://github.com/vishalm/privateGPT/commit/f09f6dd2553077d4566dbe6b48a450e05c2f049e))
* Add default mode option to settings ([#2078](https://github.com/vishalm/privateGPT/issues/2078)) ([fa3c306](https://github.com/vishalm/privateGPT/commit/fa3c30661d2ab04634361e20e7819365e3dd351a))
* add numpy issue to troubleshooting ([#2048](https://github.com/vishalm/privateGPT/issues/2048)) ([4ca6d0c](https://github.com/vishalm/privateGPT/commit/4ca6d0cb556be7a598f7d3e3b00d2a29214ee1e8))
...
* Adding azopenai to model list ([#2035](https://github.com/vishalm/privateGPT/issues/2035)) ([1c665f7](https://github.com/vishalm/privateGPT/commit/1c665f7900658144f62814b51f6e3434a6d7377f))
* auto-update version ([#2052](https://github.com/vishalm/privateGPT/issues/2052)) ([7fefe40](https://github.com/vishalm/privateGPT/commit/7fefe408b4267684c6e3c1a43c5dc2b73ec61fe4))
...
* **config:** make tokenizer optional and include a troubleshooting doc ([#1998](https://github.com/vishalm/privateGPT/issues/1998)) ([01b7ccd](https://github.com/vishalm/privateGPT/commit/01b7ccd0648be032846647c9a184925d3682f612))
...
* **deploy:** generate docker release when new version is released ([#2038](https://github.com/vishalm/privateGPT/issues/2038)) ([1d4c14d](https://github.com/vishalm/privateGPT/commit/1d4c14d7a3c383c874b323d934be01afbaca899e))
* **deploy:** improve Docker-Compose and quickstart on Docker ([#2037](https://github.com/vishalm/privateGPT/issues/2037)) ([dae0727](https://github.com/vishalm/privateGPT/commit/dae0727a1b4abd35d2b0851fe30e0a4ed67e0fbb))
...
* docker permissions ([#2059](https://github.com/vishalm/privateGPT/issues/2059)) ([8c12c68](https://github.com/vishalm/privateGPT/commit/8c12c6830b37851cccb3fea75faa820fce49284a))
...
* **docs:** Fix concepts.mdx referencing to installation page ([#1779](https://github.com/vishalm/privateGPT/issues/1779)) ([dde0224](https://github.com/vishalm/privateGPT/commit/dde02245bcd51a7ede7b6789c82ae217cac53d92))
...
* **docs:** Update installation.mdx ([#1866](https://github.com/vishalm/privateGPT/issues/1866)) ([c1802e7](https://github.com/vishalm/privateGPT/commit/c1802e7cf0e56a2603213ec3b6a4af8fadb8a17a))
...
* ffmpy dependency ([#2020](https://github.com/vishalm/privateGPT/issues/2020)) ([dabf556](https://github.com/vishalm/privateGPT/commit/dabf556dae9cb00fe0262270e5138d982585682e))
...
* Fixed docker-compose ([#1758](https://github.com/vishalm/privateGPT/issues/1758)) ([774e256](https://github.com/vishalm/privateGPT/commit/774e2560520dc31146561d09a2eb464c68593871))
* **ingest:** update script label ([#1770](https://github.com/vishalm/privateGPT/issues/1770)) ([7d2de5c](https://github.com/vishalm/privateGPT/commit/7d2de5c96fd42e339b26269b3155791311ef1d08))
* light mode ([#2025](https://github.com/vishalm/privateGPT/issues/2025)) ([1020cd5](https://github.com/vishalm/privateGPT/commit/1020cd53288af71a17882781f392512568f1b846))
* **LLM:** mistral ignoring assistant messages ([#1954](https://github.com/vishalm/privateGPT/issues/1954)) ([c7212ac](https://github.com/vishalm/privateGPT/commit/c7212ac7cc891f9e3c713cc206ae9807c5dfdeb6))
* **llm:** special tokens and leading space ([#1831](https://github.com/vishalm/privateGPT/issues/1831)) ([347be64](https://github.com/vishalm/privateGPT/commit/347be643f7929c56382a77c3f45f0867605e0e0a))
...
* make embedding_api_base match api_base when on docker ([#1859](https://github.com/vishalm/privateGPT/issues/1859)) ([2a432bf](https://github.com/vishalm/privateGPT/commit/2a432bf9c5582a94eb4052b1e80cabdb118d298e))
...
* naming image and ollama-cpu ([#2056](https://github.com/vishalm/privateGPT/issues/2056)) ([89477ea](https://github.com/vishalm/privateGPT/commit/89477ea9d3a83181b0222b732a81c71db9edf142))
* nomic embeddings ([#2030](https://github.com/vishalm/privateGPT/issues/2030)) ([5465958](https://github.com/vishalm/privateGPT/commit/54659588b5b109a3dd17cca835e275240464d275))
* prevent to ingest local files (by default) ([#2010](https://github.com/vishalm/privateGPT/issues/2010)) ([e54a8fe](https://github.com/vishalm/privateGPT/commit/e54a8fe0433252808d0a60f6a08a43c9f5a42f3b))
* publish image name ([#2043](https://github.com/vishalm/privateGPT/issues/2043)) ([b1acf9d](https://github.com/vishalm/privateGPT/commit/b1acf9dc2cbca2047cd0087f13254ff5cda6e570))
* Rectify ffmpy poetry config; update version from 0.3.2 to 0.4.0 ([#2062](https://github.com/vishalm/privateGPT/issues/2062)) ([7603b36](https://github.com/vishalm/privateGPT/commit/7603b3627d91aed1cce2e1ae407fec11ca1ad132))
...
* Replacing unsafe `eval()` with `json.loads()` ([#1890](https://github.com/vishalm/privateGPT/issues/1890)) ([9d0d614](https://github.com/vishalm/privateGPT/commit/9d0d614706581a8bfa57db45f62f84ab23d26f15))
...
* Sanitize null bytes before ingestion ([#2090](https://github.com/vishalm/privateGPT/issues/2090)) ([5fbb402](https://github.com/vishalm/privateGPT/commit/5fbb402477c41e09f56a3e5adc32f316341772bf))
...
* **settings:** enable cors by default so it will work when using ts sdk (spa) ([#1925](https://github.com/vishalm/privateGPT/issues/1925)) ([966af47](https://github.com/vishalm/privateGPT/commit/966af4771dbe5cf3fdf554b5fdf8f732407859c4))
...
* **ui:** gradio bug fixes ([#2021](https://github.com/vishalm/privateGPT/issues/2021)) ([d4375d0](https://github.com/vishalm/privateGPT/commit/d4375d078f18ba53562fd71651159f997fff865f))
...
* unify embedding models ([#2027](https://github.com/vishalm/privateGPT/issues/2027)) ([40638a1](https://github.com/vishalm/privateGPT/commit/40638a18a5713d60fec8fe52796dcce66d88258c))
* update matplotlib to 3.9.1-post1 to fix win install ([b16abbe](https://github.com/vishalm/privateGPT/commit/b16abbefe49527ac038d235659854b98345d5387))
